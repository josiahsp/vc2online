...
class MenuitemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create menuitem" do
    assert_difference('Menuitem.count') do
      post menuitems_url, params: { menuitem: { path: @menuitem.path, title: @menuitem.title } }
    end
  ...
  test "should update menuitem" do
    patch menuitem_url(@menuitem), params: { menuitem: { path: @menuitem.path, title: @menuitem.title } }
